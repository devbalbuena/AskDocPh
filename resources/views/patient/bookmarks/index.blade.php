...
<div class="space-y-4">
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-5" id="bookmark-card-{{ $post->id }}">
        <div class="flex items-start justify-between gap-4">
            <div class="flex items-start gap-3 flex-1 min-w-0">
                <div class="w-9 h-9 rounded-full bg-purple-600/30 flex items-center justify-center text-sm font-bold text-purple-300 flex-shrink-0">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-300 text-sm mt-2 line-clamp-3">{{ $post->text_content }}</p>
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-12 text-center">
        ...
        <p class="text-gray-400">You haven't bookmarked any posts yet.</p>
        <a href="{{ url('/feed') }}" class="mt-3 inline-block bg-purple-600 hover:bg-purple-700 text-white text-sm px-5 py-2.5 rounded-lg transition-colors">Go to Feed</a>
    </div>
    @endforelse
